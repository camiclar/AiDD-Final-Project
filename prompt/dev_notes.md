...
### Creating a PRD
- Tool: Cursor
- Prompt: In the docs\context\PM folder, please create a Product Requirements Documet (PRD) for this project that includes:
  - Context
  - A problem statement
  - Goals & non-goals
  ...
  - Success metrics
  - Risks
- Outcome: Cursor created a PRD for the project, however it was too long and included some irrelevant information. I iterated on it a few times and made manual edits for length and relevance.
...
### Attempting to Deploy to AWS
- Tool: Cursor
- Prompt: Okay I would now like to deploy this site using AWS Elastic Beansprout. I've signed up for an account and gotten the billing set up. What do I need to do next?
- Outcome: Cursor gave me detailed instructions for deploying to AWS and migrating the database from SQLite to Amazon's relational database service. I spent several hours following Cursor's instructions and doing external research, but was unable to successfully deploy to AWS.

### Testing & Validation
- Tool: Cursor
- Prompt: Okay now let's work on testing and validation. Please follow these requirements, and place any testing files in the tests folder.
...
- Outcome: Cursor wrote the tests, though most of them failed at first. I pointed this out to Cursor, and it updated the code. After a few iterations, all tests passed.

### Updating the README
- Tool: Cursor
- Prompt: Okay now let's rework the README. It needs to meet the following requirements:
  - Setup + run instructions
  - Database migration steps
  - The repository structure
  - MCP usage
  - Test instructions
- Outcome: Cursor successfully updated the README file. I kept its output.